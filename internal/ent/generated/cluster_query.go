...
type ClusterQuery struct {
	...
	loadTotal  []func(context.Context, []*Cluster) error
...
func (cq *ClusterQuery) FirstID(ctx context.Context) (id gidx.PrefixedID, err error) {
...
func (cq *ClusterQuery) FirstIDX(ctx context.Context) gidx.PrefixedID {
...
func (cq *ClusterQuery) OnlyID(ctx context.Context) (id gidx.PrefixedID, err error) {
	var ids []gidx.PrefixedID
...
func (cq *ClusterQuery) OnlyIDX(ctx context.Context) gidx.PrefixedID {
...
func (cq *ClusterQuery) IDs(ctx context.Context) (ids []gidx.PrefixedID, err error) {
...
func (cq *ClusterQuery) IDsX(ctx context.Context) []gidx.PrefixedID {
	ids, err := cq.IDs(ctx)
	if err != nil {
		panic(err)
	}
