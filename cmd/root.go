...
const appName = "kubernetes-cluster-api"
...
var rootCmd = &cobra.Command{
	Use:   appName,
	Short: "A kubernetes cluster graph api",
}
...
func init() {
	...
	rootCmd.PersistentFlags().String("nats-stream-name", "kubernetes-cluster-api", "nats stream name")
...
func initConfig() {
	...
	viper.SetEnvPrefix("kubernetesclusterapi")
