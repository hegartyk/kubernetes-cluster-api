...
import (
	...
	"go.infratographer.com/kubernetes-cluster-api/internal/config"
	ent "go.infratographer.com/kubernetes-cluster-api/internal/ent/generated"
)
...
var serveCmd = &cobra.Command{
	Use:   "serve",
	Short: "Start the Kubernetes Cluster Graph API",
...
func init() {
	...
	// only available as a CLI arg because it shouldn't be something that could accidentally end up in a config file or env var
